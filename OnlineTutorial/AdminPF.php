	...
	<div class="container">
		<div class="profile" style="border: 0px;margin-left: 0px;width: 90%">
			...
			<div class="inp2" style="margin-top: 30px;margin-left: 140px;font-size: 13pt;">
				...
				<b>Email ID:</b>
				<span><input type="text" class="form-control  " style="width:120%;outline: 0;border-width: 0 0 3px;" value="<?php echo"".$row['EmailID']."";?>" readonly />
				</span>
			</div> 
		</div>
		...
		<!--<div class="form-inline">
			<button class="btn btn-primary" id="makeEditable" > edit </button>
			<button class="btn btn-primary" id="makeNonEditable" > Nonedit </button>
		</div>-->
